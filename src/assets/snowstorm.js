...
var snowStorm = (function(window, document) {
  ...
  this.snowColor = '#FFA501';        // Don't eat (or use?) yellow snow.
  this.snowCharacter = `
  <svg class="animation-rotate" id="Слой_1" width="25px" height="20px" data-name="Слой 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
    <defs>
      <style>
        .cls-1 {
          fill: #f7a511;
